...
export default function SellerIdentityDocsPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Save to user profile and mark user as verified (trusted seller)
      await updateProfile({
      ...
      toast.success('Identity proof documents submitted successfully! You are now a trusted seller.');
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen text-white bg-dark py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-primary font-bold uppercase tracking-widest">Trust & Identity Verification</span>
          </div>
          <h1 className="text-4xl font-display font-bold text-white mb-2">
            Upload <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-primary">Identity Proof Documents</span>
          </h1>
          <p className="text-muted">
            Provide your identity verification documents to verify your profile and mark you as a trusted seller. Verified sellers gain higher visibility and build trust with buyers.
          </p>
        </div>
        ...
        {user?.isVerified ? (
          <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-2xl p-8 text-center space-y-4">
            ...
            <p className="text-muted max-w-md mx-auto">
              You are recognized as a trusted seller on GharBid. Your listings will show the trusted verification badge to potential buyers.
            </p>
            <button
          ...
          <>
            ...
            <div className="flex gap-3 bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-4 mb-8">
              ...
              <p className="text-sm text-yellow-200/80">
                Documents marked <span className="font-bold text-yellow-400">Required</span> must be uploaded to become a trusted user. Optional documents help verify your address.
              </p>
            </div>
